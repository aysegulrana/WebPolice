            ...
            try
            {
                ...
                foreach (string line in lines)
                {
                    ...
                    if (line == lines[0])
                    {
                        ...
                        int y = x.IndexOf(" ");
                        int second = line.Substring(line.IndexOf(" ") + 1).IndexOf(" ") + line.IndexOf(" ") + 1;
                        string s = line.Substring(line.IndexOf(" ") + 1, second - line.IndexOf(" ") - 1);
                        Int32.TryParse(s, out status);
                    ...
                    {
                        string len = line.Substring(line.IndexOf(":")+1, line.IndexOf("\r") - line.IndexOf(":")-1);
                        Int32.TryParse(len, out length);
                    }}
                }
            }
            catch (IOException e)
